...
void dsInitOggData(int numBuffer)
{
	InitOggData(&g_sinfo[numBuffer].ovf);
}
//--------------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------------
...
//	更新履歴	：	2002.06.24	Ver1.00		植山沙欧	機能の実現
//--------------------------------------------------------------------------------------------
void dsFadeOut(int numBuffer, int iValue)
{
...
//														不正処理になるバグを解消
//--------------------------------------------------------------------------------------------
HRESULT dsPlay_FadeIn(int numBuffer, DWORD dwPlayFlag, int iValue)
{
	HRESULT hRet;
