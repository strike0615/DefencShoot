...
private:
  ...
  public:
    ...
    //　leftpower  左手側のモーターを振動させる（0.0fから1.0fまで）
    //　rightpower 右手側のモーターを振動させる（0.0fから1.0fまで）
    void vibrationFrame(float leftpower, float rightpower, int frame)
    {
    ...
    //パッドを振動させる
    //　leftpower  左手側のモーターを振動させる（0.0fから1.0fまで）
    void vibrationLeftFrame(float leftpower, int frame)
    {
    ...
    //パッドを振動させる
    //　rightpower 右手側のモーターを振動させる（0.0fから1.0fまで）
    void vibrationRightFrame(float rightpower, int frame)
    {
